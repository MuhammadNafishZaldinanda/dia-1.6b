...
#     "id": "Untuk menguji performa dan akurasi tag bahasa, kalimat uji ini mengandung beberapa klausa, tanda baca yang bervariasi, serta jumlah kata yang mencukupi."
...
# test_sentences = [
#     "Untuk menguji performa dan akurasi tag bahasa, kalimat uji ini mengandung beberapa klausa, tanda baca yang bervariasi, serta jumlah kata yang mencukupi.",
#     "Selamat pagi, apa kabar?",
#     "Hari ini cuacanya cerah.",
#     "Ini adalah kalimat uji coba."
# ]

test_sentences = [
    "ˈuntʊʔ məˈŋudʒi pərˈforma dan akuˈrasi taʔ baˈhasa, kaˈlimat ˈudʒi ˈini məˈŋandʊŋ bəbəˈrapa klaˈusa, ˈtanda ˈbatʃa jaŋ bərfariˈasi, sərˈta ˈdʒumlah ˈkata jaŋ məntʃuˈkupi.",
    "səˈlamat ˈpaɡi, ˈapa ˈkabar?",
    "ˈhari ˈini tʃuaˈtʃaɲa tʃəˈrah.",
    "ˈini aˈdalah kaˈlimat ˈudʒi ˈtʃoba."
]
    ...
    try:
        ...
        with torch.inference_mode():
          for idx, sentence in enumerate(test_sentences):
            try:
                audio = dia_gen.generate(text=sentence)
                writer.add_audio(f"Eval/Sentence_{idx}", audio, global_step, 44100)
            except:
                logger.exception(f"Error synthesizing test sentence #{idx}.")
            del audio
